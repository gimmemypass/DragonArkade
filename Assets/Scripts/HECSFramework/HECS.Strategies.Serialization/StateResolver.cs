...
{
    [MessagePackObject]
    [HECSManualResolver(typeof(State))]
    public struct StateResolver : IResolver<StateResolver, State>
    {
        [Key(0)] public List<NodeContext> Nodes;

        [Key(1)] public string Name;

        public StateResolver In(ref State data)
        {
        ...
        public void Out(ref State data)
        {
